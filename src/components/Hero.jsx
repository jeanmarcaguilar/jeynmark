  ...
  return (
    <section id="home" className="min-h-screen bg-[#050505] text-white flex flex-col justify-between relative overflow-hidden select-none">
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-between min-h-screen lg:min-h-0 relative z-10 overflow-x-hidden">
        ...
        <div className="px-4 sm:px-6 lg:px-10 xl:px-14 py-12 flex-1 flex items-center justify-center">
          <div className="w-full max-w-7xl mx-auto flex flex-col items-center text-center space-y-8 md:space-y-10">
            ...
            >
              <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[5.5rem] font-black tracking-tight uppercase whitespace-nowrap leading-none drop-shadow-2xl">
            ...
            <motion.p
              ...
              className="font-mono text-zinc-400 text-base sm:text-lg md:text-xl max-w-3xl leading-relaxed mx-auto text-center"
            >
