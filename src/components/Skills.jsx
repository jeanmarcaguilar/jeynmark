...
const NodeIcon = () => (
  <svg className="w-4 h-4 shrink-0" viewBox="0 0 256 292" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="skills-nodejs__a" x1="68.188%" x2="27.823%" y1="17.487%" y2="89.755%">
      ...
      <linearGradient id="skills-nodejs__c" x1="43.277%" x2="159.245%" y1="55.169%" y2="-18.306%">
      ...
      <linearGradient id="skills-nodejs__f" x1="-4.389%" x2="101.499%" y1="49.997%" y2="49.997%">
    ...
    <path fill="url(#skills-nodejs__a)" d="M134.923 1.832c-4.344-2.443-9.502-2.443-13.846 0L6.787 67.801C2.443 70.244 0 74.859 0 79.745v132.208c0 4.887 2.715 9.502 6.787 11.945l114.29 65.968c4.344 2.444 9.502 2.444 13.846 0l114.29-65.968c4.344-2.443 6.787-7.058 6.787-11.945V79.745c0-4.886-2.715-9.501-6.787-11.944L134.923 1.832Z"/>
    <mask id="skills-nodejs__d" fill="#fff">
      <use href="#skills-nodejs__b"/>
    </mask>
    <path fill="url(#skills-nodejs__c)" d="M249.485 67.8 134.65 1.833c-1.086-.542-2.443-1.085-3.529-1.357L2.443 220.912c1.086 1.357 2.444 2.443 3.8 3.258l114.834 65.968c3.258 1.9 7.059 2.443 10.588 1.357L252.47 70.515c-.815-1.086-1.9-1.9-2.986-2.714Z" mask="url(#skills-nodejs__d)"/>
    <mask id="skills-nodejs__g" fill="#fff">
      <use href="#skills-nodejs__e"/>
    </mask>
    <path fill="url(#skills-nodejs__f)" d="M249.756 223.898c3.258-1.9 5.701-5.158 6.787-8.687L130.579.204c-3.258-.543-6.787-.272-9.773 1.628L6.786 67.53l122.979 224.238c1.628-.272 3.529-.815 5.158-1.63l114.833-66.239Z" mask="url(#skills-nodejs__g)"/>
  </svg>
);
...
const PythonIcon = () => (
  <svg className="w-4 h-4 shrink-0" fill="none" viewBox="16 16 32 32">
    <path fill="url(#skills-python__a)" d="M31.885 16c-8.124 0-7.617 3.523-7.617 3.523l.01 3.65h7.752v1.095H21.197S16 23.678 16 31.876c0 8.196 4.537 7.906 4.537 7.906h2.708v-3.804s-.146-4.537 4.465-4.537h7.688s4.32.07 4.32-4.175v-7.019S40.374 16 31.885 16zm-4.275 2.454a1.394 1.394 0 1 1 0 2.79 1.393 1.393 0 0 1-1.395-1.395c0-.771.624-1.395 1.395-1.395z"/>
    <path fill="url(#skills-python__b)" d="M32.115 47.833c8.124 0 7.617-3.523 7.617-3.523l-.01-3.65H31.97v-1.095h10.832S48 40.155 48 31.958c0-8.197-4.537-7.906-4.537-7.906h-2.708v3.803s.146 4.537-4.465 4.537h-7.688s-4.32-.07-4.32 4.175v7.019s-.656 4.247 7.833 4.247zm4.275-2.454a1.393 1.393 0 0 1-1.395-1.395 1.394 1.394 0 1 1 1.395 1.395z"/>
    <defs>
      <linearGradient id="skills-python__a" x1="19.075" x2="34.898" y1="18.782" y2="34.658" gradientUnits="userSpaceOnUse">
        <stop stop-color="#387EB8"/>
        <stop offset="1" stop-color="#366994"/>
      </linearGradient>
      <linearGradient id="skills-python__b" x1="28.809" x2="45.803" y1="28.882" y2="45.163" gradientUnits="userSpaceOnUse">
...
const RestAPIIcon = () => (
  <img className="w-4 h-4 shrink-0" src="https://cdn.simpleicons.org/fastapi/009688" alt="FastAPI" />
);
...
const Skills = () => {
  ...
  return (
    <section id="skills" className="min-h-screen flex flex-col justify-center py-10 lg:py-14 bg-white text-gray-900 relative overflow-hidden select-none">
